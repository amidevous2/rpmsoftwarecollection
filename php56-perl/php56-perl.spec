...
Requires:       %{?scl_prefix}%perl_compat
...
Requires:       %{?scl_prefix}perl-AutoLoader, %{?scl_prefix}perl-AutoSplit, %{?scl_prefix}perl-autouse,
Requires:       %{?scl_prefix}perl-B, %{?scl_prefix}perl-base, %{?scl_prefix}perl-Benchmark, %{?scl_prefix}perl-bignum, %{?scl_prefix}perl-blib,
Requires:       %{?scl_prefix}perl-Carp, %{?scl_prefix}perl-Class-Struct,
Requires:       %{?scl_prefix}perl-Compress-Raw-Bzip2, %{?scl_prefix}perl-Compress-Raw-Zlib,
Requires:       %{?scl_prefix}perl-Config-Extensions, %{?scl_prefix}perl-Config-Perl-V, %{?scl_prefix}perl-constant,
...
Requires:       %{?scl_prefix}perl-Data-Dumper, %{?scl_prefix}perl-DB_File, %{?scl_prefix}perl-DBM_Filter,
Requires:       %{?scl_prefix}perl-debugger, %{?scl_prefix}perl-deprecate,
Requires:       %{?scl_prefix}perl-Devel-Peek, %{?scl_prefix}perl-Devel-PPPort, %{?scl_prefix}perl-Devel-SelfStubber,
Requires:       %{?scl_prefix}perl-diagnostics, %{?scl_prefix}perl-Digest, %{?scl_prefix}perl-Digest-MD5, %{?scl_prefix}perl-Digest-SHA,
Requires:       %{?scl_prefix}perl-DirHandle,
Requires:       %{?scl_prefix}perl-doc,
...
Requires:       %{?scl_prefix}perl-encoding-warnings, %{?scl_prefix}perl-English,
Requires:       %{?scl_prefix}perl-Env, %{?scl_prefix}perl-Errno, %{?scl_prefix}perl-experimental, %{?scl_prefix}perl-Exporter,
Requires:       %{?scl_prefix}perl-ExtUtils-CBuilder, %{?scl_prefix}perl-ExtUtils-Constant,
Requires:       %{?scl_prefix}perl-ExtUtils-Command,
Requires:       %{?scl_prefix}perl-ExtUtils-Embed, %{?scl_prefix}perl-ExtUtils-Install,
Requires:       %{?scl_prefix}perl-ExtUtils-MakeMaker, %{?scl_prefix}perl-ExtUtils-Manifest,
Requires:       %{?scl_prefix}perl-ExtUtils-Miniperl, %{?scl_prefix}perl-ExtUtils-MM-Utils,
Requires:       %{?scl_prefix}perl-ExtUtils-ParseXS,
Requires:       %{?scl_prefix}perl-Fcntl, %{?scl_prefix}perl-fields,
Requires:       %{?scl_prefix}perl-File-Basename, %{?scl_prefix}perl-File-Compare, %{?scl_prefix}perl-File-Copy,
Requires:       %{?scl_prefix}perl-File-DosGlob, %{?scl_prefix}perl-File-Fetch,
Requires:       %{?scl_prefix}perl-File-Find, %{?scl_prefix}perl-File-Path, %{?scl_prefix}perl-File-stat, %{?scl_prefix}perl-File-Temp,
Requires:       %{?scl_prefix}perl-FileCache, %{?scl_prefix}perl-FileHandle, %{?scl_prefix}perl-filetest,
Requires:       %{?scl_prefix}perl-Filter, %{?scl_prefix}perl-Filter-Simple,
Requires:       %{?scl_prefix}perl-FindBin,
%if %{with gdbm}
Requires:       %{?scl_prefix}perl-GDBM_File,
%endif
Requires:       %{?scl_prefix}perl-Getopt-Long, %{?scl_prefix}perl-Getopt-Std,
Requires:       %{?scl_prefix}perl-Hash-Util, %{?scl_prefix}perl-Hash-Util-FieldHash, %{?scl_prefix}perl-HTTP-Tiny,
Requires:       %{?scl_prefix}perl-if, %{?scl_prefix}perl-IO, %{?scl_prefix}perl-IO-Compress, %{?scl_prefix}perl-IO-Socket-IP,
Requires:       %{?scl_prefix}perl-IO-Zlib, %{?scl_prefix}perl-IPC-Cmd, %{?scl_prefix}perl-IPC-Open3, %{?scl_prefix}perl-IPC-SysV,
Requires:       %{?scl_prefix}perl-I18N-Collate, %{?scl_prefix}perl-I18N-Langinfo, %{?scl_prefix}perl-I18N-LangTags,
Requires:       %{?scl_prefix}perl-JSON-PP,
Requires:       %{?scl_prefix}perl-less,
Requires:       %{?scl_prefix}perl-lib, %{?scl_prefix}perl-libnet, %{?scl_prefix}perl-libnetcfg,
Requires:       %{?scl_prefix}perl-locale, %{?scl_prefix}perl-Locale-Maketext, %{?scl_prefix}perl-Locale-Maketext-Simple,
Requires:       %{?scl_prefix}perl-Math-BigInt, %{?scl_prefix}perl-Math-BigInt-FastCalc, %{?scl_prefix}perl-Math-BigRat,
Requires:       %{?scl_prefix}perl-Math-Complex, %{?scl_prefix}perl-Memoize, %{?scl_prefix}perl-meta-notation,
Requires:       %{?scl_prefix}perl-MIME-Base64,
Requires:       %{?scl_prefix}perl-Module-CoreList, %{?scl_prefix}perl-Module-CoreList-tools,
Requires:       %{?scl_prefix}perl-Module-Load, %{?scl_prefix}perl-Module-Load-Conditional,
Requires:       %{?scl_prefix}perl-Module-Loaded, %{?scl_prefix}perl-Module-Metadata,
Requires:       %{?scl_prefix}perl-mro,
%if %{with gdbm}
Requires:       %{?scl_prefix}perl-NDBM_File,
%endif
Requires:       %{?scl_prefix}perl-Net, %{?scl_prefix}perl-Net-Ping, %{?scl_prefix}perl-NEXT,
%if %{with gdbm}
Requires:       %{?scl_prefix}perl-ODBM_File,
%endif
Requires:       %{?scl_prefix}perl-Opcode, %{?scl_prefix}perl-open, %{?scl_prefix}perl-overload, %{?scl_prefix}perl-overloading,
Requires:       %{?scl_prefix}perl-parent, %{?scl_prefix}perl-PathTools, %{?scl_prefix}perl-Params-Check, %{?scl_prefix}perl-perlfaq,
Requires:       %{?scl_prefix}perl-PerlIO-via-QuotedPrint, %{?scl_prefix}perl-Perl-OSType,
Requires:       %{?scl_prefix}perl-ph,
Requires:       %{?scl_prefix}perl-Pod-Checker, %{?scl_prefix}perl-Pod-Escapes, %{?scl_prefix}perl-Pod-Functions,
Requires:       %{?scl_prefix}perl-Pod-Html, %{?scl_prefix}perl-Pod-Perldoc,
Requires:       %{?scl_prefix}perl-Pod-Simple, %{?scl_prefix}perl-Pod-Usage, %{?scl_prefix}perl-podlators, %{?scl_prefix}perl-POSIX,
Requires:       %{?scl_prefix}perl-Safe, %{?scl_prefix}perl-Scalar-List-Utils,
Requires:       %{?scl_prefix}perl-Search-Dict, %{?scl_prefix}perl-SelectSaver,
Requires:       %{?scl_prefix}perl-SelfLoader, %{?scl_prefix}perl-sigtrap, %{?scl_prefix}perl-Socket, %{?scl_prefix}perl-sort,
Requires:       %{?scl_prefix}perl-Storable,
Requires:       %{?scl_prefix}perl-subs,
Requires:       %{?scl_prefix}perl-Symbol, %{?scl_prefix}perl-Sys-Hostname, %{?scl_prefix}perl-Sys-Syslog,
Requires:       %{?scl_prefix}perl-Term-ANSIColor, %{?scl_prefix}perl-Term-Cap, %{?scl_prefix}perl-Term-Complete,
...
Requires:       %{?scl_prefix}perl-Text-Abbrev, %{?scl_prefix}perl-Text-Balanced, %{?scl_prefix}perl-Text-ParseWords,
Requires:       %{?scl_prefix}perl-Text-Tabs+Wrap,
Requires:       %{?scl_prefix}perl-Thread, %{?scl_prefix}perl-Thread-Queue, %{?scl_prefix}perl-Thread-Semaphore,
Requires:       %{?scl_prefix}perl-threads, %{?scl_prefix}perl-threads-shared,
Requires:       %{?scl_prefix}perl-Tie, %{?scl_prefix}perl-Tie-File, %{?scl_prefix}perl-Tie-Memoize, %{?scl_prefix}perl-Tie-RefHash,
Requires:       %{?scl_prefix}perl-Time, %{?scl_prefix}perl-Time-HiRes, %{?scl_prefix}perl-Time-Local, %{?scl_prefix}perl-Time-Piece,
Requires:       %{?scl_prefix}perl-Unicode-Collate, %{?scl_prefix}perl-Unicode-Normalize, %{?scl_prefix}perl-Unicode-UCD,
Requires:       %{?scl_prefix}perl-User-pwent,
Requires:       %{?scl_prefix}perl-vars, %{?scl_prefix}perl-version, %{?scl_prefix}perl-vmsish,
...
# Compat provides
Provides:       %{?scl_prefix}%perl_compat
Provides:       %{?scl_prefix}perl(:MODULE_COMPAT_5.32.0)
...
%if %{with gdbm}
# For AnyDBM_File
Suggests:       %{?scl_prefix}perl(GDBM_File)
Recommends:     %{?scl_prefix}perl(NDBM_File)
Suggests:       %{?scl_prefix}perl(ODBM_File)
%endif
...
%endif
Conflicts:      %{?scl_prefix}perl < 4:5.30.1-451
...
Requires:       %{?scl_prefix}perl(overloading)
Requires:       %{?scl_prefix}perl(XSLoader)
%if %{defined perl_bootstrap}
%gendep_perl_B
%endif
Conflicts:      %{?scl_prefix}perl-interpreter < 4:5.30.1-451
...
Epoch:          0
Version:        2.093
Requires:       %{?scl_prefix}perl(Exporter), perl(File::Temp)
%if %{defined perl_bootstrap}
...
BuildArch:      noarch
# File provides
Provides:       %{?scl_prefix}perl(dumpvar.pl) = %{perl_version}
Provides:       %{?scl_prefix}perl(perl5db.pl) = %{version}
Requires:       %{?scl_prefix}%perl_compat
...
Requires:       %{?scl_prefix}perl(meta_notation) = %{perl_version}
Requires:       %{?scl_prefix}perl(mro)
%if !%{defined perl_bootstrap}
...
%endif
Conflicts:      %{?scl_prefix}perl-utils < 5.30.1-451
Conflicts:      %{?scl_prefix}perl-interpreter < 4:5.30.1-451
...
Version:        3.06
Requires:       %{?scl_prefix}%perl_compat
Requires:       %{?scl_prefix}%{name}-Encode = %{epoch}:%{version}-%{release}
...
Requires:       %{?scl_prefix}perl(base)
Requires:       %{?scl_prefix}perl(Carp)
Requires:       %{?scl_prefix}perl(Hash::Util)
%if %{defined perl_bootstrap}
%gendep_perl_fields
%endif
Conflicts:      %{?scl_prefix}perl < 4:5.30.1-451
...
Version:        0.23
Requires:       %{?scl_prefix}%perl_compat
Requires:       %{?scl_prefix}perl(Hash::Util::FieldHash)
Requires:       %{?scl_prefix}perl(XSLoader)
%if %{defined perl_bootstrap}
...
Requires:       %{?scl_prefix}%perl_compat
Requires:       %{?scl_prefix}perl(Fcntl)
Requires:       %{?scl_prefix}perl(IO::Pipe)
Requires:       %{?scl_prefix}perl(POSIX)
Requires:       %{?scl_prefix}perl(warnings)
%if %{defined perl_bootstrap}
...
Version:        %{perl_version}
BuildArch:      noarch
Provides:       %{?scl_prefix}perl(meta_notation) = %{perl_version}
Requires:       %{?scl_prefix}%perl_compat
%if %{defined perl_bootstrap}
...
# a documentation.
Provides:       %{?scl_prefix}perl(sys/ioctl.ph) = %{perl_version}
Provides:       %{?scl_prefix}perl(sys/syscall.ph) = %{perl_version}
Provides:       %{?scl_prefix}perl(syscall.ph) = %{perl_version}
%if %{defined perl_bootstrap}
%gendep_perl_ph
%endif
Conflicts:      %{?scl_prefix}perl < 4:5.30.1-451
...
Requires:       %{?scl_prefix}%perl_compat
Requires:       %{?scl_prefix}perl(Carp)
Requires:       %{?scl_prefix}perl(Tie::ExtraHash)
%if %{defined perl_bootstrap}
...
#
# lib/perl5db.t will fail if Term::ReadLine::Gnu is available%{?scl:EOF}
