%{?scl:%scl_package docbook-dtds}
%{!?scl:%global pkg_name docbook-dtds}
...
Obsoletes: %{?scl_prefix}docbook-dtd30-sgml < %{version}-%{release}
Obsoletes: %{?scl_prefix}docbook-dtd31-sgml < %{version}-%{release}
Obsoletes: %{?scl_prefix}docbook-dtd40-sgml < %{version}-%{release}
Obsoletes: %{?scl_prefix}docbook-dtd41-sgml < %{version}-%{release}
Obsoletes: %{?scl_prefix}docbook-dtd412-xml < %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd-xml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd30-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd31-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd40-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd41-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd412-xml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd42-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd42-xml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd43-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd43-xml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd44-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd44-xml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd45-sgml = %{version}-%{release}
Provides: %{?scl_prefix}docbook-dtd45-xml = %{version}-%{release}

Requires(post): %{?scl_prefix}libxml2-devel
Requires(postun): %{?scl_prefix}libxml2-devel
Requires(post): /usr/bin/chmod
Requires(post): sed
Requires(postun): sed
Requires: %{?scl_prefix}sgml-common
Requires: %{?scl_prefix}xml-common
...
cd 3.0-sgml
unzip %{SOURCE0}
%patch -P 0 -p0 -b docbook.cat
cd ..

# DocBook V3.1
cd 3.1-sgml
unzip %{SOURCE1}
%patch -P 1 -p0 -b docbook.cat
cd ..

# DocBook V4.0
cd 4.0-sgml
unzip %{SOURCE2}
%patch -P 2 -p0 -b docbook.cat
cd ..

# DocBook V4.1
cd 4.1-sgml
unzip %{SOURCE3}
%patch -P 3 -p0 -b docbook.cat
cd ..
